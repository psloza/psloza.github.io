...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8805316.869616, -53526.446628, -8662382.423680, 19812.918599], 
        maxZoom: 20, 
        minZoom: 10
    })
});
...
map.getView().fit([-8805316.869616, -53526.446628, -8662382.423680, 19812.918599], map.getSize());
