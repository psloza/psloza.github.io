...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 35, minZoom: 27, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Parroquias_DMQ_geograficas_1,
      colName: 'PARROQUIA',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-78.812445, -0.429719, -77.908256, 0.096791], map.getSize());
